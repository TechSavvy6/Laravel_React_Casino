    ...
    <div class="bonus_page_container">
        ...
        @if(strpos(Auth::user()->login, 'id') !== false)
            <div class="bonus_option" onclick="window.open('https://vk.com/bets.play2x')">
                ...
                <div class="bonus_option_content">
                    ...
                    <div class="bonus_option_description">Вступи в группу ВКонтакте и получи 0.45 &nbsp;<i class="fad fa-coins"></i> на счет!</div>
        ...
        <div id="notificationOption" style="display: none" class="bonus_option">
            ...
            <div class="bonus_option_content">
                ...
                <div class="bonus_option_description">Подпишись на уведомления с промокодами и новостями и получи 1 &nbsp;<i class="fad fa-coins"></i> на счет!</div>
    ...
    <div class="bonus_page_container">
        <div class="bonus_option" onclick="window.open('https://vk.com/bets.play2x')">
            <div class="bonus_option_content">
                ...
                <div class="bonus_option_name" style="width: 75%;">Сотрудничество</div>
        ...
        <div class="bonus_option" onclick="$('.md-promo').toggleClass('md-show', true)">
            <div class="bonus_option_content">
                ...
                <div class="bonus_option_description">Введи промокод или реферальный код и получи бонус на счет!</div>
